...
@section('breadcrumb')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Manager edit</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Manager edit</li>
                </ol>
    ...
    <div class="contentbar">
        ...
        <div class="row">
            <div class="card m-b-30 col-12 ">
                ...
                <div class="card-body">
                    <form class="row justify-content-center" method="POST" action="{{ route('admin.manager.update', $manager) }}"
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $manager->phone }}" name="phone" type="text" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="select2-single form-control">
                                        <option @if ($manager->status) == true) selected @endif value="1">Active </option>
                                        <option @if ($manager->status) == false) selected @endif value="0">Inactive </option>
                                    </select>
                                    @error('status')
                                    <div class="alert alert-danger" role="alert">
                                        {{ $message }}
                                ...
                                <div class="col-sm-10">
                                    <select name="branch" class="select2-single form-control">
                                        ...
                                        @foreach($branches as $branch)
                                            <option @if ($manager->branch->id == $branch->id) selected @endif value="{{ $branch->id }}"> {{ $branch->name }} </option>
                                        @endforeach
                                    </select>
                                    @error('branch')
                                    <div class="alert alert-danger" role="alert">
