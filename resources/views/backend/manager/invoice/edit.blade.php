                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control search-item" id="sender-name" name="sender-name"
                            placeholder="Sender name" value="{{ $invoice->sender_name }}">
                    </div>
                    @if ($invoice->condition_amount > 0)
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control search-item" id="sender-phone" name="sender-phone"
                                placeholder="Sender phone" value="{{ $invoice->sender_phone }}">
                        </div>
                    @endif
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control search-item" id="receiver-name" name="receiver-name"
                            placeholder="Receiver name" value="{{ $invoice->receiver->name ?? '' }}">
                    </div>
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control search-item" id="receiver-phone" name="receiver-phone"
                            placeholder="Receiver phone" value="{{ $invoice->receiver->phone ?? '' }}">
                    </div>
                    <div class="form-group col-md-3" style="display:none;">
                        ...
                        <input type="email" class="form-control search-item" id="receiver-email" name="receiver-email"
                            placeholder="Receiver Email" value="{{ $invoice->receiver->email ?? '' }}">
                    </div>
                </div>
                            ...
                            <label class="btn btn-outline btn-info button-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="branch-{{ $linked_branch->toBranch->id }}" name="branch"
                                        @if ($invoice->to_branch_id == $linked_branch->toBranch->id) checked @endif value="{{ $linked_branch->toBranch->id }}"
                ...
                @if ($invoice->condition_amount > 0)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control is-valid" id="condition-amount" name="condition-amount"
                            value="{{ $invoice->condition_amount }}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control is-valid" id="condition-charge" name="condition-charge"
                            value="{{ $invoice->condition_charge }}">
                    </div>
                @endif
                <div class="form-group">
                    <textarea class="form-control" rows="5" id="description" name="description"
                        placeholder="Description">{!! $invoice->description !!}</textarea>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control price" onClick="this.select();" min="0" id="price"
                                value="{{ $invoice->price }}">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control labour" onClick="this.select();" min="0" id="labour"
                    ...
                    <div class="form-group col-md-6" style="display:none">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control bg-danger due" id="due" disabled readonly
                                value="{{ $invoice->price + $invoice->home + $invoice->labour - $invoice->paid }}">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control bg-success total" min="0" id="total" disabled
                                readonly value="{{ $invoice->price + $invoice->home + $invoice->labour }}">
                        </div>
                    </div>
                    <div class="form-group col-md-6" style="display:none">
                        <div class="input-group mb-3">
                    ...
                    success: function(data) {
                        ...
                        var array = $.map(data, function(obj) {
                            return {
                                ...
                                label: obj.sender_name + ' ' + obj
                                .sender_phone, //Show as label of input field
                    ...
                    success: function(data) {
                        ...
                        var array = $.map(data, function(obj) {
                            return {
                                ...
                                label: obj.name + '<br>' + obj.phone + '<br>' +
                                    obj.email, //Show as label of input field
                                phone: obj.phone,
                                email: obj.email,
