   ...
   <div class="contentbar">
    ...
    <div class="row">
        <div class="card m-b-30 col-12 ">
            ...
            <div class="card-body">
                <form class="row justify-content-center" method="POST" action="{{ route('superadmin.user.store') }}"
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group row">
                            <label for="status" class="col-sm-4 col-form-label">Type</label>
                            <div class="col-sm-8">
                                <select name="type" class="select2-single form-control">
                                    <option @if (old('status') == 'Super Admin') selected @endif value="Super Admin"> Super Admin </option>
                                    <option @if (old('status') == 'Admin') selected @endif value="Admin"> Admin </option>
                                    <option @if (old('status') == 'Manager') selected @endif value="Manager"> Manager </option>
                                    <option @if (old('status') == 'Customer') selected @endif value="Customer"> Customer </option>
                                </select>
                                @error('type')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
