...
@section('breadcrumb')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Home content Q/A edit</h4>
        </div>
                    ...
                    <form class="row justify-content-center" method="POST" action="{{ route('superadmin.homeContentFaq.update', $homeContentFaq) }}"
                        ...
                        <div class="col-lg-10">
                                ...
                                <div class="col-sm-8">
                                    <select name="home_content" id="home_content" class="select2-single form-control">
                                        @foreach($home_contents as $home_content)
                                            <option @if ($homeContentFaq->home_content_id ==  $home_content->id) selected class="bg-success" @endif value="{{ $home_content->id }}"> {{ $home_content->title }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input value="{{  $homeContentFaq->question }}" name="question" type="text" class="form-control"
                                        id="question" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea name="answer" type="text" class="form-control" id="answer">
                                        {!!  $homeContentFaq->answer !!}</textarea>
                                </div>
                            </div>
