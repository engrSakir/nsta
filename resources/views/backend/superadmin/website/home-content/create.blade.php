   ...
   <div class="contentbar">
    ...
    <div class="row">
        <div class="card m-b-30 col-12 ">
            ...
            <div class="card-body">
                <form class="row justify-content-center" method="POST" action="{{ route('superadmin.homeContent.store') }}"
                    ...
                    <div class="col-lg-10">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input value="{{ old('serial') }}" name="serial" type="text" class="form-control"
