    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('superadmin.portfolioCategory.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create Portfolio Category</a>
            </div>
        </div>
    </div>
@endsection
...
<script>
    $(function() {
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('superadmin.portfolioCategory.index') !!}',
            columns: [{
                    data: 'name',
                    name: 'name'
                },
