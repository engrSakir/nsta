...
class PortfolioCategoryController extends Controller
{
         ...
         if ($request->ajax()){
            ...
            return datatables::of($data)
                ...
                ->addColumn('action', function($data) {
                    return '<a href="'.route('admin.portfolioCategory.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('admin.portfolioCategory.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['portfolios','action'])
                ->make(true);
        }else{
            return view('backend.admin.website.portfolio.category-index');
        }
    }
    ...
    {
       return view('backend.admin.website.portfolio.category-create');
    }
    ...
    {
        return view('backend.admin.website.portfolio.category-edit', compact('portfolioCategory'));
    }
