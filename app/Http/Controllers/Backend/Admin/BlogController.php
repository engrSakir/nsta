...
class BlogController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ...
                ->addColumn('status', function($data) {
                    ...
                    return '<a href="'.route('admin.blog.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('admin.blog.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['writer','status','image','action'])
                ->make(true);
        }else{
            return view('backend.admin.website.blog.index');
        }
    }
    ...
    {
        return view('backend.admin.website.blog.create');
    }
    ...
    {
        return view('backend.admin.website.blog.edit', compact('blog'));
    }
