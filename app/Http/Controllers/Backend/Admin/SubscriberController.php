...
class SubscriberController extends Controller
{
            ...
            return datatables::of($data)
               ->addColumn('email', function ($data) {
                ...
                ->addColumn('action', function ($data) {
                    return '<button class="text-white btn btn-danger " onclick="delete_function(this)" value="'. route('admin.subscriber.destroy', $data).'">Delete</button>';
                })
                ->rawColumns(['email','action'])
                ->make(true);
        } else {
            return view('backend.admin.website.subscriber.index');
        }
    }
    ...
    public function subscriberEmail(){
        ...
        return view('backend.admin.website.subscriber.email', compact('subscriber'));
    }
