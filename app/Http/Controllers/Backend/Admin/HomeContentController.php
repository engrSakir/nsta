...
class HomeContentController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('faq', function($data) {
                    ...
                    return '<a href="'.route('admin.homeContent.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('admin.homeContent.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['faq','status','image','action'])
                ->make(true);
        }else{
            return view('backend.admin.website.home-content.index');
        }
    }
    ...
    {
        return view('backend.admin.website.home-content.create');
    }
    ...
    {
        return view('backend.admin.website.home-content.edit', compact('homeContent'));
    }
