        ...
        if ($request->ajax()) {
            ...
            return datatables::of($data)
                ->addColumn('image', function ($data) {
                    ...
                    return '<a href="' . route('superadmin.gallery.edit', $data) . '" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="' . route('superadmin.gallery.destroy', $data) . '"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['image', 'action'])
                ->make(true);
        } else {
            return view('backend.superadmin.website.gallery.index');
        }
    }
