...
class CallToActionController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return datatables::of($data)
                ...
                ->addColumn('action', function($data) {
                    return '<a href="'.route('superadmin.callToAction.edit', $data).'" class="btn btn-info"><i class="fas fa-edit"></i> </a>
                   <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.callToAction.destroy', $data).'"><i class="fas fa-trash"></i> </button>';
                })
                ->rawColumns(['action_name', 'status', 'action'])
                ->make(true);
        } else {
            return view('backend.superadmin.website.call-to-action.index');
        }
    }
    ...
    {
        return view('backend.superadmin.website.call-to-action.create');
    }
    ...
    {
        return view('backend.superadmin.website.call-to-action.edit', compact('callToAction'));
    }
