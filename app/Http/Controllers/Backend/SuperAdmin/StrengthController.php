...
class StrengthController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('action', function($data) {
                    return '<a href="'.route('superadmin.strength.edit', $data).'" class="btn btn-info"><i class="fas fa-edit"></i> </a>
                   <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.strength.destroy', $data).'"><i class="fas fa-trash"></i> </button>';
                })
                ->rawColumns(['action'])
                ->make(true);
        }else{
            return view('backend.superadmin.website.strength.index');
        }
    }
    ...
    {
        return view('backend.superadmin.website.strength.create');
    }
    ...
    {
        return view('backend.superadmin.website.strength.edit', compact('strength'));
    }
    ...
    public function strength(){
        return view('backend.superadmin.website.strength.strength');
    }
