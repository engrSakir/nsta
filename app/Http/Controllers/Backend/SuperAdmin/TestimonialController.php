...
class TestimonialController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('writer_avatar', function($data) {
                    ...
                    return '<a href="'.route('superadmin.testimonial.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.testimonial.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['writer_avatar','action'])
                ->make(true);
        }else{
            return view('backend.superadmin.website.testimonial.index');
        }
    }
    ...
    {
        return view('backend.superadmin.website.testimonial.create');
    }
    ...
    {
        return view('backend.superadmin.website.testimonial.edit', compact('testimonial'));
    }
