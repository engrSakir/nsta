...
class HomeContentFaqController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('homeContent', function($data) {
                    ...
                    return '<a href="'.route('superadmin.homeContentFaq.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.homeContentFaq.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['homeContent','action'])
                ->make(true);
        }else{
            return view('backend.superadmin.website.home-content-q-a.index');
        }
    }
    ...
    public function create()
    {
        ...
        return view('backend.superadmin.website.home-content-q-a.create', compact('home_contents'));
    }
    ...
    {
        $home_contents = HomeContent::all();
        return view('backend.superadmin.website.home-content-q-a.edit', compact('homeContentFaq', 'home_contents'));
    }
