...
class PortfolioController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('image', function($data) {
                    ...
                    return '<a href="'.route('superadmin.portfolio.edit', $data).'" class="btn btn-info"><i class="fas fa-edit"></i> </a>
                   <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.portfolio.destroy', $data).'"><i class="fas fa-trash"></i> </button>';
                })
                ->rawColumns(['image','status', 'action'])
                ->make(true);
        }else{
            return view('backend.superadmin.website.portfolio.index');
        }
    }
    ...
    public function create()
    {
        ...
        return view('backend.superadmin.website.portfolio.create', compact('portfolioCategories'));
    }
    ...
    {
        $portfolioCategories = PortfolioCategory::all();
        return view('backend.superadmin.website.portfolio.edit', compact('portfolioCategories','portfolio'));
    }
    ...
    public function portfolio(){
        return view('backend.superadmin.website.portfolio.portfolio');
    }
