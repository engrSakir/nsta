...
class CustomPageController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ...
                ->addColumn('status', function($data) {
                    ...
                    return '<a href="'.route('superadmin.customPage.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('superadmin.customPage.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['writer','status','image','action'])
                ->make(true);
        }else{
            return view('backend.superadmin.website.custom-page.index');
        }
    }
    ...
    {
        return view('backend.superadmin.website.custom-page.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.customPage.edit', $customPage)->withSuccess('Successfully created');
    }
    ...
    {
        return view('backend.superadmin.website.custom-page.edit', compact('customPage'));
    }
